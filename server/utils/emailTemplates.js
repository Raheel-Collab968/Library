export function generateVerificationOtpEmailTemplate(otpCode) {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; background: #f9f9f9; border-radius: 8px;">
      <h2 style="color: #0b74de; text-align: center;">Verify Your Email Address</h2>
      <p style="font-size: 16px; color: #333;">Dear User,</p>
      <p style="font-size: 16px; color: #333;">To complete your registration or login, please use the following OTP:</p>
      
      <div style="text-align: center; margin: 20px 0;">
        <span style="display: inline-block; font-size: 28px; font-weight: bold; color: #0b74de; padding: 12px 24px; border: 1px solid #ddd; border-radius: 6px; background: #fff;">
          ${otpCode}
        </span>
      </div>

      <p style="font-size: 15px; color: #555;">This code is valid for <strong>15 minutes</strong>. Please do not share it with anyone.</p>
      <p style="font-size: 15px; color: #555;">If you did not request this email, you can safely ignore it.</p>
