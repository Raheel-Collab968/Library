    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 p-5 flex items-center justify-center z-50">
          ...
          <div className="p-6">
            ...
            <div className="mb-4 sm:flex gap-4 items-center">
              ...
              <input type="password" value={currentPassword} onChange={(e)=> setCurrentPassword(e.target.value)}
               placeholder="Current Password" className="w-full px-4 py-2 border border-gray-300 
               rounded-md"/>
            </div>
              ...
              <input type="password" value={newPassword} onChange={(e)=> setNewPassword(e.target.value)}
               placeholder="Set New Password" className="w-full px-4 py-2 border border-gray-300 
               rounded-md"/>
            </div>
              ...
              <input type="password" value={confirmNewPassword} onChange={(e)=> setConfirmNewPassword(e.target.value)}
               placeholder="Confirm New Password" className="w-full px-4 py-2 border border-gray-300 
               rounded-md"/>
            </div>
        ...
        {/* Buttons */}
            {/* <div className="flex justify-end space-x-4">
              ...
              bg-gray-200 rounded-md hover:bg-gray-300">Close</button>
              <button type="Submit" disabled={loading} onClick={()=> dispatch(toggleAddNewAdminPopup())} className="px-4 py-2
              bg-black rounded-md hover:bg-gray-800 text-white">Add</button>
            </div> */}

            <div className='flex gap-4 mt-10'>
              <button type="button" onClick={()=> dispatch(toggleSettingPopup())} className="px-4 py-2
              bg-gray-200 rounded-md hover:bg-gray-300">Cancel</button>
              <button type="Submit" className="px-4 py-2
              bg-black rounded-md hover:bg-gray-800 text-white">CONFIRM</button>
            </div>
