      ...
      <div className="flex flex-[4] flex-col gap-7 lg:gap-16 lg:px-7 lg:py-5 justify-between xl:min-h-[85.5vh]">
        <div className="flex flex-col-reverse lg:flex-row gap-7 flex-[4]">
          ...
          <div className="flex flex-col gap-5">
            ...
            rounded-lg transition hover:shadow-inner duration-300 w-full lg:max-w-[360px] mb-5">
              ...
              <div className="flex flex-col items-center gap-2">
                <h4 className="text-black text-3xl">{totalUsers}</h4>
            ...
            rounded-lg transition hover:shadow-inner duration-300 w-full lg:max-w-[360px] mb-5">
              ...
              <span className="w-[2px] bg-black h-20 lg:h-full"></span>
              <div className="flex flex-col items-center gap-2">
                <h4 className="text-black text-3xl">{totalBooks}</h4>
           ...
           <div className="flex flex-col gap-5">
            ...
            rounded-lg transition hover:shadow-inner duration-300 w-full lg:max-w-[360px]">
              ...
              <span className="w-[2px] bg-black h-20 lg:h-full"></span>
              <div className="flex flex-col items-center gap-2">
                <h4 className="text-black text-3xl">{totalAdmin}</h4>
          ...
          <div className="flex flex-col lg:flex-row flex-1 items-center justify-center">
            ...
            items-center gap-4">
              ...
              <p className="text-gray-600 text-sm 2xl:text-base">
                Welcom to your admin dashboard. Here you can manage all the setting and monitor the statistics.
              </p>
            </div>
          </div>
        </div>
        ...
        font-semibold relative flex-[3] justify-center items-center rounded-2xl">
          <h4 className="overflow-y-hidden">"Embarking on the journy of reading foasters personal growth,
            naturing a path towards excellence and the refinedment of character."</h4>
          <p className="text-gray-700 text-sm sm:text-lg absolute right-[35px] sm:right-[78px] 
          bottom-[10px]">~ BookWorm Team</p>
        </div>
