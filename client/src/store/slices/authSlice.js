...
export const register = (data) => async(dispatch) =>{
    ...
    await axios.post(`${backendUrl}/api/v1/auth/register`, data, {
...
export const getUser = () => async(dispatch) =>{
    ...
    await axios.get(`${backendUrl}/api/v1/auth/me`, {
        withCredentials: true,
    }).then(res=>{
...
export const forgotPassword = (email) => async(dispatch) =>{
    ...
    await axios.post(`${backendUrl}/api/v1/auth/password/forgot`, {email}, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json",
        },
...
export const resetPassword = (data, token) => async(dispatch) =>{
    ...
    await axios.put(`${backendUrl}/api/v1/auth/password/reset/${token}`, data, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json",
        },
...
export const updatePassword = (data) => async(dispatch) =>{
    ...
    await axios.put(`${backendUrl}/api/v1/auth/password/update`, data, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json",
        },
