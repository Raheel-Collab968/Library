...
<aside
  className={`
    fixed z-10 h-full w-64 bg-black text-white flex flex-col
...
>
      ...
      <nav className="flex-1 px-6 space-y-2">
        <button className="w-full py-2 font-medium bg-transparent
        ...
        <button className="md:hidden w-full py-2 font-medium bg-transparent
        rounded-md hover:cursor-pointer flex items-center space-x-2"
      ...
      <button className="py-2 font-medium text-center bg-transparent rounded-md 
