  ...
  return <>
   ...
   <div className="flex flex-col justify-center md:flex-row h-screen">
    ...
    <div className="hidden w-full md:w-1/2 bg-black text-white
      md:flex flex-col items-center justify-center p-8 rounded-tr-[80px] rounded-br-[80px]">
    ...
    <div className="w-full max-w-sm">
      ...
      <form onSubmit={handleRegister}>
        ...
        text-white py-2 rounded-lg hover:bg-white hover:text-black transition">SIGN UP</button>
      </form>
